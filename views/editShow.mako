...
%>
<%block name="metas">
<meta data-var="series.is_anime" data-content="${series.is_anime}">
</%block>
<%block name="scripts">
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair">
                            <label for="location">
                                ...
                                <span class="component-desc">
                                    <input type="hidden" name="indexername" id="form-indexername" value="${series.indexer_name}" />
                                    <input type="hidden" name="seriesid" id="form-seriesid" value="${series.series_id}" />
                                    <input type="text" name="location" id="location" value="${series._location}" class="form-control form-control-inline input-sm input350"/>
                                </span>
                            </label>
                        </div>
                        <div class="field-pair">
                            <label for="qualityPreset">
                                ...
                                <span class="component-desc">
                                    <% allowed_qualities, preferred_qualities = common.Quality.split_quality(int(series.quality)) %>
                            ...
                            <label for="defaultEpStatusSelect">
                                ...
                                <span class="component-desc">
                                    <select name="defaultEpStatus" id="defaultEpStatusSelect" class="form-control form-control-inline input-sm">
                                        ...
                                        <option value="${cur_status}" ${'selected="selected"' if cur_status == series.default_ep_status else ''}>${statusStrings[cur_status]}</option>
                                        % endfor
                                    </select>
                        ...
                        <div class="field-pair">
                            <label for="indexerLangSelect">
                                ...
                                <span class="component-desc">
                                    <select name="indexer_lang" id="indexerLangSelect" class="form-control form-control-inline input-sm bfh-languages" data-blank="false" data-language="${series.lang}" data-available="${','.join(indexerApi().config['valid_languages'])}"></select>
                        ...
                        <div class="field-pair">
                            <label for="subtitles">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="subtitles" name="subtitles" ${'checked="checked"' if series.subtitles == 1 and app.USE_SUBTITLES is True else ''} ${'' if app.USE_SUBTITLES else 'disabled="disabled"'}/> search for subtitles
                                </span>
                            </label>
                        </div>
                        <div class="field-pair">
                            <label for="paused">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="paused" name="paused" ${'checked="checked"' if series.paused == 1 else ''} /> pause this show (Medusa will not download episodes)
                                </span>
                            </label>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair">
                            <label for="airbydate">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="airbydate" name="air_by_date" ${'checked="checked"' if series.air_by_date == 1 else ''} /> check if the show is released as Show.03.02.2010 rather than Show.S02E03.<br>
                        ...
                        <div class="field-pair">
                            <label for="anime">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="anime" name="anime" ${'checked="checked"' if series.is_anime == 1 else ''}> check if the show is Anime and episodes are released as Show.265 rather than Show.S02E03<br>
                                    % if series.is_anime:
                        ...
                        <div class="field-pair">
                            <label for="sports">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="sports" name="sports" ${'checked="checked"' if series.sports == 1 else ''}/> check if the show is a sporting or MMA event released as Show.03.02.2010 rather than Show.S02E03<br>
                                    <span style="color:rgb(255, 0, 0);">In case of an air date conflict between regular and special episodes, the later will be ignored.</span>
                                </span>
                            </label>
                        </div>
                        <div class="field-pair">
                            <label for="season_folders">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="season_folders" name="flatten_folders" ${'' if series.flatten_folders == 1 and not app.NAMING_FORCE_FOLDERS else 'checked="checked"'} ${'disabled="disabled"' if app.NAMING_FORCE_FOLDERS else ''}/> group episodes by season folder (uncheck to store in a single folder)
                                </span>
                            </label>
                        </div>
                        <div class="field-pair">
                            <label for="scene">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="scene" name="scene" ${'checked="checked"' if series.scene == 1 else ''} /> search by scene numbering (uncheck to search by indexer numbering)
                                </span>
                            </label>
                        </div>
                        <div class="field-pair">
                            <label for="dvdorder">
                                ...
                                <span class="component-desc">
                                    <input type="checkbox" id="dvdorder" name="dvd_order" ${'checked="checked"' if series.dvd_order == 1 else ''} /> use the DVD order instead of the air order<br>
                    ...
                    <fieldset class="component-group-list">
                        <div class="field-pair">
                            <label for="rls_ignore_words">
                                ...
                                <span class="component-desc">
                                    <input type="text" id="rls_ignore_words" name="rls_ignore_words" id="rls_ignore_words" value="${series.rls_ignore_words}" class="form-control form-control-inline input-sm input350"/><br>
                        ...
                        <div class="field-pair">
                            <label for="rls_require_words">
                                ...
                                <span class="component-desc">
                                    <input type="text" id="rls_require_words" name="rls_require_words" id="rls_require_words" value="${series.rls_require_words}" class="form-control form-control-inline input-sm input350"/><br>
                                    <div class="clear-left">
                                        <p>comma-separated <i>e.g. "word1,word2,word3"</i></p>
                            ...
                            <label for="SceneName">
                                ...
                                <span class="component-desc">
                                    ...
                                    <div class="pull-left">
                                        ...
                                        % for cur_exception in series.exceptions:
